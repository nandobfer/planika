...
export const Trips: React.FC<TripsProps> = (props) => {
    ...
    const disabledStyle = trips.loading ? { filter: "grayscale(100%) blur(1px)", pointerEvents: "none" } : {}
    ...
    return (
        <Box sx={{ flexDirection: "column", padding: 5, gap: { xs: 2, md: 5 }, height: 1, position: "relative" }}>
            ...
            {trips.loading && <LinearProgress sx={{ width: 1, position: "absolute", top: 0, right: 0, left: 0 }} variant="indeterminate" />}
